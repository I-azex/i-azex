...
Я начинающий Python-разработчик и студент.  
Изучаю Python и backend-разработку, создаю Telegram-ботов,  
скрипты автоматизации и постепенно развиваю собственные проекты.
...
🎓 Студент  
🐍 Изучаю Python  
⚙️ Интересуюсь автоматизацией  
🤖 Создаю Telegram-ботов  
🌐 Развиваюсь в Backend Development  
...
🔭 Сейчас работаю над учебными и пет-проектами  
🌱 Изучаю Python и основы backend-разработки  
🤖 Создаю ботов и инструменты автоматизации  
🎯 Цель — получить первые реальные проекты и развиваться как разработчик
...
GitHub: [@I-azex](https://github.com/I-azex)